...
const STEPS: TutStep[] = [
  {
    id: 'intro_stun',
    title: 'RÈGLE D\'OR',
    instruction: 'Clippy n\'est touchable QUE quand il est étourdi.\nEsquivez quand il CLIGNOTE EN JAUNE !\nTrop tôt ou trop tard = raté.',
    hint: '',
    missMsg: '',
    clippyAttack: null,
    expect: 'none',
  ...
  },
  {
    ...
    hint: 'Quand il clignote JAUNE → souris à droite ou →',
    missMsg: 'Raté ! Esquivez quand il clignote jaune.',
  ...
  },
  {
    ...
    hint: 'Quand il clignote JAUNE → souris à gauche ou ←',
    missMsg: 'Esquivez quand il clignote jaune.',
  ...
  },
  {
    ...
    hint: 'Quand il clignote JAUNE → souris vers le bas ou ↓',
    missMsg: 'Baissez-vous quand il clignote jaune.',
